...
- **Right-click the corner dot** for **Options…**: default color, font and size for new notes, which
  side of the screen new notes appear on, which screen corner the dot lives in, how
...
Public domain, under the [Unlicense](LICENSE). All of the code in this repository was generated by
an AI assistant (Claude) from specifications written by the repository owner, who makes no copyright
claim to it and dedicates whatever rights might exist to the public domain. Use it however you like.
