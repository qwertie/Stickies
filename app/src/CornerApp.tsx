 ...
 * tray icon: hover raises the last-used note without focusing it, click brings every note to the
 * front, double-click creates a note, right-click shows the app menu (built in Rust so the tray
 * can share it).
 */
export function CornerApp() {
  return (
    <div
      ...
      onMouseEnter={() => void invoke('raise_latest')}
      onContextMenu={(e) => {
        e.preventDefault();
